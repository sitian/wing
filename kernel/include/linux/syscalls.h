...
asmlinkage long sys_shm_rdprotect(key_t key, unsigned long pgoff, char __user * buf);
asmlinkage long sys_shm_wrprotect(key_t key, unsigned long pgoff, char __user * buf);
